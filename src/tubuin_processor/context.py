...
from tubuin_processor.core.ingestion import load_unit_definitions
from tubuin_processor.core.exceptions import ParserError
from tubuin_processor.schemas.unit_defs_schema import UnitDef
...
def build_execution_context(
    ...
    if unit_defs_path:
        ...
        try:
            with importlib.resources.path("tubuin_processor.config.defaults", "unitdefs.json") as p:
